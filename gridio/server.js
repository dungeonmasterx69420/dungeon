...
app.listen(PORT, () => {
  ...
  setInterval(() => stmts.purgeSessions.run(Date.now()), 24 * 3600 * 1000);
  console.log(`GRIDIO up on :${PORT} | season ${espn.SEASON} | invite code: ${INVITE_CODE}`);
});
